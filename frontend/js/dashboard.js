...
async function loadProfile() {
    try {
        ...
        document.getElementById('queryQuota').textContent = data.query_quota || 0;
        document.getElementById('profileUsername').textContent = data.username;
        document.getElementById('profileEmail').textContent = data.email;
        document.getElementById('profileCreated').textContent = data.created_at?.substring(0, 10) || '';
        document.getElementById('profileQuota').textContent = data.query_quota || 0;
